...
namespace SapphireApi.Migrations
{
    ...
    [Migration("20210324202051_AddPriceListTableAndDetails")]
    partial class AddPriceListTableAndDetails
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SapphireApi.Data.Adminsitration.SystemInitialization.Currencies.Rates.CurrencyRateModel", b =>
                {
            ...
            modelBuilder.Entity("SapphireApi.Data.Adminsitration.SystemInitialization.Company.CompanyModel", b =>
                {
                    ...
                    b.HasOne("SapphireApi.Data.Adminsitration.SystemInitialization.Currencies.CurrencyModel", "mainCurrency")
                        .WithOne("mainFor")
                        .HasForeignKey("SapphireApi.Data.Adminsitration.SystemInitialization.Company.CompanyModel", "mainCur")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("SapphireApi.Data.Adminsitration.SystemInitialization.Currencies.CurrencyModel", "systemCurrency")
                        .WithOne("sysFor")
                        .HasForeignKey("SapphireApi.Data.Adminsitration.SystemInitialization.Company.CompanyModel", "sysCur")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SapphireApi.Data.Inventory.Transactions.Batch.BatchTransactionModel", b =>
                {
                    ...
                    b.HasOne("SapphireApi.Data.Adminsitration.Setup.Objects.ObjectModel", "masterObjType")
                        .WithMany("batchTransactions")
                        .HasForeignKey("masterObjTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SapphireApi.Data.Adminsitration.Setup.Series.SerieModel", "masterSerie")
                        .WithMany("batchTransactions")
